...
| `beneficios/30008 1.png` · `3146 1.png` · `2151847309 1.png` | `texture-heart-vessels.png` · `texture-vessels.png` · `texture-ecg-chest.png` | Texturas de fundo do hero; o `30008` também é a textura da seção Why (1386×777 em left 556,95, opacity .4, luminosity, blur 5,54px) e o `2151847309` a do banner de frete |
