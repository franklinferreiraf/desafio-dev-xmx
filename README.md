...
- **Não vieram no pacote e continuam gerados por script (SVG simples):** o ícone de gota do logo, o favicon e as bandeiras de pagamento (Visa, Mastercard, Amex, Discover).
...
- **axe-core 4.10** em 360 e 1440px: **0 violações**.
...
2. Pedir ao design uma **imagem de 2 potes** para o card BASIC e o **ícone do logo** exportado.
